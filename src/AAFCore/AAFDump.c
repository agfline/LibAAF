...
void aaf_dump_ObjectProperty( AAF_Data *aafd, aafProperty *Prop, const char *padding )
{
	struct aafLog *log = aafd->log;
...
void aaf_dump_TaggedValueSet( AAF_Data *aafd, aafObject *ObjCollection, const char *padding )
{
	struct aafLog *log = aafd->log;
...
void aaf_dump_ObjectProperties( AAF_Data *aafd, aafObject *Obj, const char *padding )
{
	/*
...
void aaf_dump_rawProperties( AAF_Data *aafd, aafByte_t *propStream, const char *padding )
{
	struct aafLog *log = aafd->log;
...
void aaf_dump_nodeStreamProperties( AAF_Data *aafd, cfbNode *node, const char *padding )
{
	/*
